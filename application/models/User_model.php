...
class User_model extends CI_Model {
    ...
    public function add_user($data){
        ...
        if((in_array($data['type'], array(1,2))) && ($data['email'])){
            ...
            $this->email->message("Welcome to Holding Bricks CRM System,<br><br>Your user name is ".$data['emp_code']." And password is ".$data['emp_code']." by using them please login to the tool with the following link: <a href=\"http://crm.holdingbricks.com/\" >http://crm.holdingbricks.com/</a> <br><br>Regards Holding Bricks IT team");
            $this->email->send();
        }
    }
